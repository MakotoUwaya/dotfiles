...
description: AIで書いた日本語を、人間が書いた文章に戻す。ブログ・記事・エッセイなど書き手の一人称がある文章の下書き、編集、レビュー時に「AI臭を消して」「slop を直して」で使用。全角ダッシュや偏愛語のような表層だけでなく、主体の不在、命題型H2、壮大化、両論併記、リズムの均一さといった構造レベルを直す。敬体のビジネス文書（報告書・議事録・提案書）の文体を整えるのは humanizer-ja、技術書・書籍原稿の執筆規範は japanese-tech-writing。
metadata:
