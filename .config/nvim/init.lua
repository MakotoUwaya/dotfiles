...
keymap.set('n', '<C-Up>', '<cmd>resize -3<CR>', { desc = 'Shrink window height' })
keymap.set('n', '<C-Down>', '<cmd>resize +3<CR>', { desc = 'Grow window height' })
keymap.set('n', '<C-Left>', '<cmd>vertical resize -3<CR>', { desc = 'Shrink window width' })
keymap.set('n', '<C-Right>', '<cmd>vertical resize +3<CR>', { desc = 'Grow window width' })
